...
function fun_val = Objective_Fun(x,R)       %Penalty function
    ...
    fun_val = fun + R*(g1*g1 + g2*g2 + g3*g3 + g4*g4 + g5*g5 + g6*g6 ) ;
end    

out = fopen('opt_phase3_Q3_out.txt', 'w'); % Output file
% step 1 ##########################################################
N = 8;%input('Enter no of variable N = ') ;
A = [100 1000 1000 10 10 10 10 10 ] ; %input('Enter lower  limit of x is A = ') ;
B = [10000 10000 10000 1000 1000 1000 1000 1000 ] ; %input('Enter upper  limit of x is B = ') ;
R(1) = 0.1 ;
eps = 0.001 ;
for i=1:N 
